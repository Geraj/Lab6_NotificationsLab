...
public class DownloaderTaskFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        friends = this.getArguments().getIntegerArrayList("friends");
    ...
    public class DownloaderTask extends AsyncTask<ArrayList<Integer>, Void, String[]> {
        ...
        protected String[] doInBackground(ArrayList<Integer>... params) {
            String[]  result = downloadTweets(params[0].toArray(new Integer[params[0].size()]));
            return result;
        }
			...
			mContext.sendOrderedBroadcast(new Intent(
					...
					new BroadcastReceiver() {
						...
						public void onReceive(Context context, Intent intent) {
							...
							if (getResultCode() != MainActivity.IS_ALIVE/*!intent.getAction().equals("course.labs.notificationslab.MainActivity")*/) {
